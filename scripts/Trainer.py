...
train_data = data_loader.Cxr8ImageDatasetLoader(annotations_file=TRAIN_SET, img_dir=RAW_DATA, transform=train_transform)
test_data = data_loader.Cxr8ImageDatasetLoader(annotations_file=TEST_SET, img_dir=RAW_DATA, transform=test_transform)
...
if SAFE_MODEL:
    model_pipeline.save_model(net, f'../models/Net_{NET}__Transf_{TRANSFORMER}__Epochs_{EPOCHS}.pth')
...
if TASK == 'Classification':
    ...
    helpers.evaluate_binary(CONFIG['PLOT_DIR_BINARY'], CONFIG['NAME'], y_true, y_proba)
